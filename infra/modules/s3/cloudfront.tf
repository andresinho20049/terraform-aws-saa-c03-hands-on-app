resource "aws_cloudfront_origin_access_control" "cloudfront_s3_oac" {
    name                              = "${var.account_username}-${var.region}-${var.app_name}-s3-oac-${var.environment}"
...
resource "aws_cloudfront_cache_policy" "cloudfront_s3_static_site_cache_policy" {
    name = "${var.account_username}-${var.region}-${var.app_name}-cache-policy-${var.environment}"
